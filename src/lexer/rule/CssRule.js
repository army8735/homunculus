...
var CssRule = Rule.extend(function() {
  ...
  ['%', 'em', 'px', 'rem', 'ex', 'ch', 'vw', 'vh', 'vm', 'cm', 'mm', 'in', 'pt', 'pc', 's', 'ms', 'Hz', 'kHz', 'fr', 'gr', 'dpi', 'dppx'].forEach(function(o) {
  ...
  COLORS: 'maroon darkred brown firebrick crimson red mediumvioletred palevioletred deeppink fuchsia magenta hotpink pink lightpink mistyrose lavenderblush indigo purple darkmagenta darkorchid blueviolet darkviolet slateblue mediumpurple mediumslateblue mediumorchid violet plum thistle lavender saddlebrown sienna chocolate indianred rosybrown lightcorol salmon lightsalmon orangered tomato coral darkorange sandybrown peru tan burlywood wheat moccasin navajowhite peachpuff bisque antuquewhite papayawhip cornsilk oldlace linen seashell snow floralwhite ivory mintcream darkgoldenrod goldenrod gold yellow darkkhaki khaki palegoldenrod beige lemonchiffon lightgoldenrodyellow lightyellow darkslategray darkolivegreen olive darkgreen forestgreen seagreen green teal lightseagreen madiumaquamarine mediumseagreen darkseagreen yellowgreen limegreen lime chartreuse lawngreen greenyellow mediumspringgreen springgreen lightgreen palegreen aquamarine honeydew midnightblue navy darkblue darkslateblue mediumblue royalblue dodgerblue cornflowerblue deepskyblue lightskyblue lightsteelblue lightblue steelblue darkcyan cadetblue darkturquoise mediumturquoise turquoise skyblue powderblue paleturquoise lightcyan azure aliceblue aqua cyan black dimgray gray slategray lightslategray dakgray silver lightgray gainsboro whitesmoke ghostwhite white'.split(' ')
});
